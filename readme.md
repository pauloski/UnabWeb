Home ꉂ(˵˃ ᗜ ˂˵) ⋆˚꩜.ᐟ = s2_g2 link trello: https://trello.com/b/U1wDpA3Y/home-ꉂ˵˃-ᗜ-˂˵-⋆˚꩜ᐟ
...
Bienvenidos al repositorio del proyecto de **Diseño Web**, donde cada grupo trabajará de manera autónoma desarrollando páginas web con **HTML, CSS y JavaScript**, integrando sus trabajos con **GitHub** y desplegando producción en **Cloudflare**.  https://unabweb.pages.dev/
...
│   ├── styles.css                    # Estilos globales del proyecto
│
├── s1_g1/                              # Estilos globales del proyecto
│   ├── styles.css                    # Estilos globales del proyecto
│
```
